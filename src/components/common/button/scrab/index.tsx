  ...
  return (
    <StyledScrabButton onClick={onClick}>
      <svg
        ...
        fill="none"
      >
        <g filter="url(#filter0_d_570_466)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            fill={isScrabbed ? "white" : "black"}
          />
        </g>
        <defs>
          <filter
            id="filter0_d_570_466"
            x="0.5"
            y="0.5"
            width="48"
            height="49.4944"
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_570_466"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_570_466"
              result="shape"
            />
          </filter>
        </defs>
